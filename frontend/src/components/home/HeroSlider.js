...
export const IndicatorDot = styled.div`
  ...
  background: ${(props) =>
    props.slide === parseInt(props.index) ? "#fff" : "transparent"};
  margin: 0 5px;
  cursor: pointer;
...
export const Slide = styled.div`
  position: absolute;
  display: ${(props) =>
    props.slide === parseInt(props.index) ? "block" : "none"};
  overflow: hidden;
  align-items: center;
  top: 0;
  left: 0;
      ...
      <SliderContainer>
        <Slide data-testid="slider1" slide={slide} index={1}>
          ...
          <SliderContent>
            ...
            <SliderTitle>
              super discount <br></br>
              hamburguesa
            </SliderTitle>
            <ButtonPrimary as={Link} to="/menu">
              order now
            </ButtonPrimary>
          </SliderContent>
        </Slide>
        ...
        <Slide data-testid="slider3" slide={slide} index={3}>
          <SliderImage src={EmpanadaSlide} alt="empanadas"></SliderImage>
          <SliderContent>
            <Span>THE BEST DEALS</Span>
            <SliderTitle>
              super discount <br></br>Empanadas
            </SliderTitle>
            <ButtonPrimary as={Link} to="/menu">
              order now
            </ButtonPrimary>
        ...
        <ControlsWrapper>
          <ControlLeft data-testid="prevButton" onClick={prevSlide} />
          <ControlRight data-testid="nextButton" onClick={nextSlide} />
        </ControlsWrapper>
